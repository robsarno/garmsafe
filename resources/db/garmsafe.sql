...
CREATE TABLE `statuto` (
  `id` int(10) UNSIGNED NOT NULL,
  `titolo` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
  `descrizione` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
(15, 'Articolo 15 - Assemblea dei soci - luogo di convocazione', 'L\'assemblea può essere convocata sia presso la sede sociale sia altrove, purchè in Italia.', 3),
